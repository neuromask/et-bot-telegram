    ...
    init: bot => {
        ...
        bot.command(["/weather", "/pogoda"], ctx => {
            ...
            weather.getCurrent().then(async data => {
                ...
                answer += `• 🌎 ${translate('weather.details', ctx)}: *https://bit.ly/3scCWBW*\n\n`
                ...
                bot.telegram.sendMessage(ctx.chat.id, answer, { parse_mode: "Markdown", disable_web_page_preview:"True" });
